...
function Coffee(size, isDecaf, qtyCream, qtySugar) {
    ...
    this.description = function() {
        output.textContent = `A ${this.size} ${(this.isDecaf === true ? "decaffeinated" : "caffeinated")} coffee with ${this.qtyCream} creamers and ${this.qtySugar} teaspoons of sugar.`;
    };
}
...
/* STEP 6b: See how this new object inherits from the prototype with megansCoffee.__proto__ in the console. */
